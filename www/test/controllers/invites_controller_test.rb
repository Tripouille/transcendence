...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post invites_url, params: { invite: { guild_id: @invite.guild_id, user_id: @invite.user_id } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { guild_id: @invite.guild_id, user_id: @invite.user_id } }
