...
ActiveRecord::Schema.define(version: 2021_05_26_102611) do
  ...
  add_foreign_key "guilds", "users", column: "owner_id", on_delete: :cascade
  add_foreign_key "users", "guilds", on_delete: :nullify
end
